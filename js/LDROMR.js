...
LDR.OMR.InlineUnofficialParts = function() {
    ...
    let checkers = {checkPartType: pt => (pt.isPart() && pt.ldraw_org && pt.ldraw_org.startsWith('Unofficial_')) ? title(pt.ID) : false};

    let handlers = {handlePartType: pt => {if(pt.isPart() && pt.inlined && pt.ldraw_org && pt.ldraw_org.startsWith('Unofficial_')){pt.inlined = undefined;}}};
